...
public class DyeConfig extends ControlledConfig {
	...
	public DyeConfig(DragonAPIMod mod, ConfigList[] option, IDRegistry[] blocks, IDRegistry[] items, IDRegistry[] id, int cfg) {
